  ...
  <div class="external">
    <div class="container">
      ...
      <div class="external-slider">
        ...
        ref="cardSlider" 
        :options="swiperCard" >
          <swiper-slide :key="index" v-for="(external, index) in data.list">
            <ExternalItem :data="external" />
          </swiper-slide>
        </swiper>
...
const ExternalItem = () => import('~/components/ExternalItem.vue')
export default {
  name: 'ExternalNews',
  components: {
    TitleH3, ExternalItem
  },
  props: {
    data: {
      type: Object,
